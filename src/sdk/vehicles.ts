...
export class Vehicles {
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.batchResponse = utils.objectToClass(httpRes?.data, shared.BatchResponse);
                }
                break;
        }
    ...
    async get(
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.vehicleInfo = utils.objectToClass(httpRes?.data, shared.VehicleInfo);
                }
                break;
        }
    ...
    async getPermissions(
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.permission = utils.objectToClass(httpRes?.data, shared.Permission);
                }
                break;
        }
    ...
    async getTirePressure(
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.tirePressure = utils.objectToClass(httpRes?.data, shared.TirePressure);
                }
                break;
        }
