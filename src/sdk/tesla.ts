...
export class Tesla {
  ...
  async getAmmeter(
    ...
    const res: operations.GetTeslaAmmeterResponse =
      new operations.GetTeslaAmmeterResponse({
  ...
  async getCompass(
    ...
    const res: operations.GetTeslaCompassResponse =
      new operations.GetTeslaCompassResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
  ...
  async getSpeedometer(
    ...
    const res: operations.GetTeslaSpeedResponse =
      new operations.GetTeslaSpeedResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
  ...
  async getVoltage(
    ...
    const res: operations.GetTeslaVoltageResponse =
      new operations.GetTeslaVoltageResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
  ...
  async getWattmeter(
    ...
    const res: operations.GetTeslaWattmeterResponse =
      new operations.GetTeslaWattmeterResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
  ...
  async setAmmeter(
    ...
    const res: operations.SetTeslaAmmeterResponse =
      new operations.SetTeslaAmmeterResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
